...
${assets.fontLicense}
  ...
  <body>
    <header>
      ...
      <a class="brand" href="https://www.spatius.ai/?utm_source=create-spatius-app" target="_blank" rel="noopener noreferrer" aria-label="Spatius home"><svg aria-hidden="true" width="128.402" height="33" viewBox="0 0 128.402 33" fill="none" xmlns="http://www.w3.org/2000/svg">
<g>
...
<path d="M96.1029 12.7109V9.12204H93.0242V13.0859H95.7278C95.9348 13.0859 96.1029 13.254 96.1029 13.461V15.7911C96.1029 15.9981 95.9348 16.1661 95.7278 16.1661H93.0242V23.9319C93.0242 24.5861 93.3888 25.3497 93.8974 25.7083H97.2971C97.0721 25.5058 96.1029 24.6056 96.1029 23.9319V16.5412C96.1029 16.3342 96.2709 16.1661 96.478 16.1661H99.1516V13.0859H96.478C96.2709 13.0859 96.1029 12.9179 96.1029 12.7109Z" fill="black"/>
    ...
    <footer><a href="https://www.spatius.ai/?utm_source=create-spatius-app" target="_blank" rel="noopener noreferrer">Explore Spatius <svg aria-hidden="true" viewBox="0 0 20 20" fill="none"><path d="M5 15 15 5M7 5h8v8" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" /></svg></a></footer>
  </body>
</html>`;
